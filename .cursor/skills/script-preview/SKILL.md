...
2. Keep preview human-readable, but format it like FileMaker Script Workspace.
...
```bash
python3 .cursor/skills/script-preview/scripts/saxmlpreview.py agent/xml_parsed/scripts/<solution>/<path/to/script.xml>
```
