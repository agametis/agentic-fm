...
def main():
    ...
    log.info(
        "Endpoints: "
        "GET /health  GET /pending  GET /watch/status  GET /watch/results  "
        "GET /watch/stream  GET /watch/ui  GET /clipboard  GET /webviewer/status  "
        "GET /preview/<name>  POST /explode  POST /context  POST /clipboard  "
        "POST /trigger  POST /debug  POST /pending  POST /watch/import-log/start  "
        "POST /watch/pick-path  POST /watch/stop  POST /webviewer/start  "
        "POST /webviewer/stop  POST /webviewer/push  POST /preview/<name>"
    )
